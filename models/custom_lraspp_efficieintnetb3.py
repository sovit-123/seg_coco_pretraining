...
def _lraspp_efficientnetb3(backbone: None, num_classes: int) -> LRASPP:
...
def lraspp_efficientnetb3(
    *,
    weights = None,
    progress: bool = True,
    num_classes: Optional[int] = None,
    weights_backbone: Optional[EfficientNet_B3_Weights] = EfficientNet_B3_Weights.IMAGENET1K_V1,
    **kwargs: Any,
) -> LRASPP:
    ...
    weights_backbone = EfficientNet_B3_Weights.verify(weights_backbone)
    ...
    backbone = efficientnet_b3(weights=weights_backbone)
    model = _lraspp_efficientnetb3(backbone, num_classes)
