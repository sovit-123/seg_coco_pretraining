...
from torchvision.models.mobilenet import MobileNetV2, MobileNet_V2_Weights, mobilenet_v2
...
def _lraspp_mobilenetv2(backbone: None, num_classes: int) -> LRASPP:
...
if __name__ == '__main__':
    model = lraspp_mobilenet_v2_small()
    summary(model)