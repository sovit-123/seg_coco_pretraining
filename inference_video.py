...
from custom_utils import get_segment_labels, draw_segmentation_map, image_overlay
from config import ALL_CLASSES
from models.custom_lraspp_mobilenetv3_small import lraspp_mobilenet_v3_small
...
model = lraspp_mobilenet_v3_small(num_classes=len(ALL_CLASSES)).to(device)
...
while(cap.isOpened()):
    ...
    if ret:
        ...
        rgb_frame = cv2.resize(rgb_frame, (512, 416))
        # get the start time
