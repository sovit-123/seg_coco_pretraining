...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/media/sovitdl/crucial1tb/my_data/Data_Science/projects/Computer_Vision/object_detection/input/coco_json/coco2017", type=str, help="dataset path")
